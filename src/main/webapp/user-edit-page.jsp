	...
	<body class="bg-dark">
		...
		<form method="POST" class="text-black" role="form" action='apply?command=update_user'>
  			...
  			<div class="form-group p-2">
    			...
    			<input type="text" class="form-control" id="secondName" name="secondName" value='<c:out value="${user.secondName}"/>'>
  			</div>
  			<div class="form-group p-2">
  			...
  			<div class="form-group p-2">
    			...
    			<input type="text" class="form-control" id="age" name="age" value='<c:out value="${user.age}"/>'>
  			</div>
  			<div class="form-group p-2">
    			<label for="phoneNumber">Phone Number:</label>
    			<input type="text" class="form-control" id="phoneNumber" name="phoneNumber" value='<c:out value="${user.phoneNumber}"/>'>
  			</div>
  			<div class="form-group p-2">
