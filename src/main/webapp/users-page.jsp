        ...
        <table class="table table-hover table-dark mb-0 p-3">
  			<thead>
     			<tr>
      				...
      				<th scope="col"><h4>Second Name</h4></th>
      				<th scope="col"><h4>Last Name</h4></th>
      				<th scope="col"><h4>Age</h4></th>
      				<th scope="col"><h4>Phone</h4></th>
  			...
  			<c:forEach var="user" items="${list}">
    			<tr>
      				...
      				<td scope="col" class="py-3"><c:out value="${user.secondName}"/></td>
      				<td scope="col" class="py-3"><c:out value="${user.lastName}"/></td>
      				<td scope="col" class="py-3"><c:out value="${user.age}"/></td>
      				<td scope="col" class="py-3"><c:out value="${user.phoneNumber}"/></td>
