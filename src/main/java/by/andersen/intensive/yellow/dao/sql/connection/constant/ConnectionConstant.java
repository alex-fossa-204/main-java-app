package by.andersen.intensive.yellow.dao.sql.connection.constant;

import static by.andersen.intensive.yellow.dao.sql.connection.constant.PropertiesConstant.*;
