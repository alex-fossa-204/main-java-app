...
public class GetSingleUserReportsListCommand  implements Command {
	...
	public Page execute(HttpServletRequest httpServletRequest) {
		...
		try {
			...
			List<Report> reportsPage = reportService.getAllReportsForSingleUserPageable(currentUserName);
	...
	public String toString() {
		...
		builder.append("GetSingleUserReportsListCommand []");
